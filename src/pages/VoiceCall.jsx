...
export default function VoiceCall() {
  ...
  return (
    <div className="h-[100dvh] bg-[#0b141a] text-white flex flex-col relative overflow-hidden font-sans">
      ...
      <div className="z-20 bg-[#121b22] px-6 py-10 rounded-t-[40px] flex justify-between items-center border-t border-white/5 shadow-2xl">
        ...
        <button 
          ...
          className={`p-3 rounded-full transition-colors ${isMuted ? 'bg-white text-black' : 'bg-white/5 text-white'}`}
        >
