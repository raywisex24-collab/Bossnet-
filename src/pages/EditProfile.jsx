    ...
    <div className="min-h-screen bg-boss-bg text-boss-text font-sans pb-10">
      ...
      <div className="px-4 space-y-6">
        ...
        <div className="border-b border-white/10 pb-2">
          <label className="text-gray-500 text-[11px] uppercase font-bold tracking-wider">First Name</label>
          <input 
            value={firstName}
        ...
        {/* Full Name Field */}
        <div className="border-b border-white/10 pb-2">
          <label className="text-gray-500 text-[11px] uppercase font-bold tracking-wider">Full Name</label>
          <input 
            value={fullName}
