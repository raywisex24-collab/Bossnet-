...
export default function PreSplash() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-between py-24 bg-boss-bg">
      ...
      <div className="w-full max-w-[500px] text-center px-6">
        ...
        <p className="text-xl font-bold text-boss-text tracking-widest uppercase opacity-90">
